...
if __name__ == '__main__':
    ...
    anchorsPlanner = AnchorsPlanner(trainPath, models, reqs, 0.95, len(featureNames),featureNames, controllableFeaturesNames, X_train, "../explainability_plots", controllableFeatureIndices, controllableFeatureDomains
                                    , optimizationDirections, optimizationScore, 1, targetConfidence)
